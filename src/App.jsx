      ...
      >
        ...
        <div
          ...
          style={{
            ...
            zIndex: 0,
            background:
              'linear-gradient(180deg, rgba(11,15,10,0.50) 0%, rgba(11,15,10,0.35) 40%, rgba(11,15,10,0.65) 100%)',
            pointerEvents: 'none',
          }}
        />
          ...
          <div className="flex-1 flex justify-end">
            ...
            >
              ...
              <CorrelatePanel
                ...
                onVesselSelect={setSelectedVesselId}
              />
              <ReportPanel selectedVesselId={selectedVesselId} />
            </div>
          </div>
        </div>
      </section>
